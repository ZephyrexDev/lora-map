...
To use this tool, run a local instance or deploy your own copy.
...
2. In `Site Parameters > Site / Transmitter`, enter a name for the site, the geographic coordinates, and the antenna height above ground. Refer to the regional parameters and input the transmit power, frequency, and antenna gain for your device.
