...
class TestParseP2pOutput:
    def test_parses_itm_path_loss(self):
        ...
        result = Splat._parse_p2p_output(stdout, frequency_mhz=907.0, fallback_distance_km=10.0)
    ...
    def test_parses_itwom_path_loss(self):
        ...
        result = Splat._parse_p2p_output(stdout, frequency_mhz=907.0, fallback_distance_km=5.0)
    ...
    def test_detects_obstruction_as_nlos(self):
        ...
        result = Splat._parse_p2p_output(stdout, frequency_mhz=907.0, fallback_distance_km=20.0)
    ...
    def test_falls_back_to_free_space_loss(self):
        ...
        result = Splat._parse_p2p_output(stdout, frequency_mhz=907.0, fallback_distance_km=3.0)
        assert result.path_loss_db == 89.12

    def test_uses_fallback_distance_when_not_parsed(self):
        stdout = "ITM path loss: 110.00 dB\n"
        result = Splat._parse_p2p_output(stdout, frequency_mhz=907.0, fallback_distance_km=7.5)
